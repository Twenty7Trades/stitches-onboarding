...
function init() {
  ...
  console.log('📝 Notes Agent - Initializing...');
  console.log('');
  ...
  rl.question('Project Type (Next.js, React, Node.js, etc.): ', (type) => {
    ...
    rl.question('Production URL (optional, press Enter to skip): ', (url) => {
      ...
      rl.question('Staging URL (optional, press Enter to skip): ', (stagingUrl) => {
        ...
        console.log('');
        console.log('✅ Documentation files initialized!');
        console.log(`📄 Created: ${PROJECT_NOTES}`);
        console.log(`📄 Created: ${DEPLOYMENT_LOG}`);
        console.log(`📄 Created: ${SESSION_LOG}`);
        console.log(`📄 Created: ${CONFIG_FILE}`);
        console.log('');
        console.log('💡 Run "node notes-agent/notes-agent.js update" to refresh documentation');
        console.log('💡 Run "node notes-agent/notes-agent.js session" to add a session summary');
...
function addSession() {
  ...
  console.log('📝 Add Session Summary');
  console.log('---');
  console.log('');
        ...
        rl.question('Files changed (comma-separated, or Enter to skip): ', (files) => {
          ...
          rl.question('Blockers encountered (comma-separated, or Enter to skip): ', (blockers) => {
            ...
            rl.question('Next steps (comma-separated, or Enter to skip): ', (nextSteps) => {
              ...
              console.log('');
              console.log('✅ Session added to documentation!');
              rl.close();
            });
          });
        });
...
function addNote() {
  ...
  console.log('📝 Add Important Note/Decision');
  console.log('---');
  console.log('');
      ...
      rl.question('Solution: ', (solution) => {
        ...
        rl.question('Files Changed (comma-separated, or Enter to skip): ', (files) => {
          ...
          rl.question('Related Info (links, references, etc.): ', (related) => {
            ...
            console.log('');
            console.log('✅ Note added to documentation!');
            rl.close();
          });
        });
      });
